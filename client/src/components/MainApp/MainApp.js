        ...
        <div className={styles.container}>
            <div className={styles.sideBar}>
                ...
                <div className={styles.filters}>
                    <SearchBar/>
                    <Filter nameFilter={'Alphabetical Order'} filter = {alphabet} funtion={handleFilterName}/>
                    <Filter nameFilter={'Rating'} filter = {rating} funtion={handleFilterRating}/>
                     ...
                     currentVideogame.map(game=>{
                        return (
                            <div className={styles.bg} key={game.id}>
                                <Link className={styles.textLink} to={"/videogame/" + game.id}>
                                <Card
                                key={game.id}
                                name={game.name}
                                genre={game.genre ? game.genre : game.Generos.map(g=>g.name)} 
                                img={game.img}
